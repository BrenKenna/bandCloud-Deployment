...
public class StorageController {
	...
	private boolean checkFiles() {
		...
		InputStream dataStream = getClass().getClassLoader().getResourceAsStream("test_data/site_audio_acoustic.mp3");
		textFile = new File(getClass().getClassLoader().getResource("test_data/todo.txt").getFile());
		audioFile = new File( getClass().getClassLoader().getResource("test_data/site_audio_acoustic.mp3").getFile());
		
		if (dataStream == null | !textFile.exists() | !audioFile.exists()) {
